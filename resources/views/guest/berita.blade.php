...
<!-- Masthead-->
<header class="masthead" style='min-height:25rem;height:25vh'>
    <div class="container px-4 px-lg-5 h-40">
        <div class="row gx-4 gx-lg-5 h-40 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end">
                <h1 class="text-white fw-bolder">Berita</h1>
                <hr class="divider" />
            </div>
