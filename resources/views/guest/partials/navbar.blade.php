...
<section class="top-h" style="background-color: #14a2ba !important;">
    <div class="row justify-content-center p-2">
        <div class="col-lg-4 d-flex justify-content-between align-items-center text-white"
        ...
        <div class="col-lg-3 d-flex justify-content-end align-items-center text-white"
            style="font-family:Arial, Helvetica, sans-serif; font-size: 12px;">
            ...
            <a class="nav-link ms-3 myBtna" href="{{ url('admin/login') }}">Login</a>
        </div>
    </div>
</section>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu animate slideIn"
                        style="border: 0 !important; border-radius: 0; font-family:Arial, Helvetica, sans-serif;"
                        data-aos="fade-down">
                        <li><a class="dropdown-item fw-bolder text-muted" href="{{ url('tentang-kami') }}">Tentang
                                Kami</a></li>
                        <li><a class="dropdown-item fw-bolder text-muted"
                                href="{{ url('struktur-organisasi') }}">Struktur Organisasi</a></li>
                        <li><a class="dropdown-item fw-bolder text-muted"
                                href="{{ url('penghargaan') }}">Penghargaan</a></li>
                        <li><a class="dropdown-item fw-bolder text-muted" href="{{ url('budaya-perusahaan') }}">Budaya
                                Perusahaan</a></li>
                        <li><a class="dropdown-item fw-bolder text-muted"
                                href="{{ url('sertifikasi') }}">Sertifikasi</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                    ...
                    <ul class="dropdown-menu animate slideIn"
                        ...
                        @foreach ($units as $unit)
                            <li><a class="dropdown-item fw-bolder text-muted"
                                    href="{{ url('unit', $unit->nama) }}">{{$unit->nama_lengkap}}</a></li>
                        @endforeach
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu animate slideIn"
                        style="border: 0 !important; border-radius: 0; font-family:Arial, Helvetica, sans-serif;">
                        <li><a class="dropdown-item fw-bolder text-muted" href="{{ url('siaran-pers') }}"><i
                                    class="bi bi-collection-play-fill"></i> Siaran Pers</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <a class="navbar-brand" href="#page-top"><img style="background-color: white"
                src="{{ url('/storage/logo.png')}}" alt="PLN Nusantara" class="lytzd-logo"></a>
