...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" >
    <div class="carousel-inner" style="height:900px">
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block" style="color: white; padding: 1rem; left: 10%; top: 50%; transform: translateY(-50%); text-align: left; width: auto;">
                <h1 style="font-size: 2.5rem;" style="">Optimis dengan Mengoptimalkan <br>Potensi yang ada, Membuka diri,<br> Serta peka terhadap perubahan agar <br>selalu exist</h1>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5" data-aos="flip-left">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="mt-5">
                <a href="{{ url('guest/login') }}" style="text-decoration:none; color:black;">
