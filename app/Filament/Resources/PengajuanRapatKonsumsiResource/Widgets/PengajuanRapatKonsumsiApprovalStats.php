...
namespace App\Filament\Resources\PengajuanRapatKonsumsiResource\Widgets;
...
class PengajuanRapatKonsumsiApprovalStats extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $queryPengajuan = PengajuanRapatKonsumsi::query();
        ...
        $needMyApproval = $myApproverIds->isNotEmpty()
            ? PengajuanApproval::where('jenis_pengajuan', 'pengajuan_rapat_konsumsi')
