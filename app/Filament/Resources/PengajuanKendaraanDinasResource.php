...
class PengajuanKendaraanDinasResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        $columns = [
            ...
            Tables\Columns\TextColumn::make('approver_info')
                ->label('Approver')
                ->getStateUsing(function (PengajuanKendaraanDinas $record): ?string {
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('approve')
                    ...
                    ->visible(fn (PengajuanKendaraanDinas $record): bool => static::canProcessApproval($record))
                    ->action(function (PengajuanKendaraanDinas $record): void {
                ...
                Tables\Actions\Action::make('reject')
                    ...
                    ->visible(fn (PengajuanKendaraanDinas $record): bool => static::canProcessApproval($record))
                    ->action(function (PengajuanKendaraanDinas $record, array $data): void {
                        $approver = static::getCurrentApprover();
                ...
                Tables\Actions\EditAction::make()
                    ->visible(fn (PengajuanKendaraanDinas $record): bool => static::canModifyRecord($record)),
    ...
    {
        return 'pengajuan_kendaraan_dinas';
    }
    ...
    protected static function canProcessApproval(PengajuanKendaraanDinas $record): bool
    {
        $approver = static::getCurrentApprover();
    ...
    protected static function canModifyRecord(PengajuanKendaraanDinas $record): bool
    {
